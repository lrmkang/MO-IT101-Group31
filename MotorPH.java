...
public class MotorPH {
    ...
    if ( (username.equalsIgnoreCase("employee") || username.equalsIgnoreCase("payroll_staff")) && password.equals("12345") ) {
        ...
        if (username.equalsIgnoreCase("employee")) {
            ...
            int choice = scanner.nextInt();
                if (choice == 1) {
                   ...
                   try {
                    FileReader fileReader = new FileReader("employee_data.csv");
                    ...
                    String empNumFromFile = data[0];   // Employee #
