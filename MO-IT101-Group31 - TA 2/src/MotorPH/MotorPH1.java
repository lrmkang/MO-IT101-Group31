                ...
                if (subChoice == 1) {
                    ...
                    double philhealth;
                        ...
                        if (totalSalary < 10000) {
                            ...
                            philhealth = (totalSalary * 0.03) / 2;
                        }

                    // Compute Pag-IBIG contribution with a maximum cap of 100
                    double pagibig = (totalSalary <= 1500) ? totalSalary * 0.01 : totalSalary * 0.02;
                    if (pagibig > 100) pagibig = 100;

                    // Compute taxable income after mandatory deductions
                ...
                // If user chooses to process payroll for all employees
                    ...
                    try { // Open employee data file to read all employees
                        ...
                        while ((empLine = empReader.readLine()) != null) { // Loop through each employee in the file
                            ...
                            // Compute Pag-IBIG contribution with maximum cap
                            double pagibig = (totalSalary <= 1500) ? totalSalary * 0.01 : totalSalary * 0.02;
                            if (pagibig > 100) pagibig = 100;
