...
public class MotorPH2 {
    public static void main(String[] args) {
        ...
        if (username.equals("employee")) { // Employee can only view their personal information
            ...
            if (subChoice == 1) {
                ...
                try {
                    ...
                    if (empNumFromFile.equals(employeeNumber) && month >= 6 && month <= 12) {
                        ...
                        double hoursWorked = end - start -1 - 0.1/*This is the 1 hour off and 10 minutes graceful landing*/ ;
                            if (day <= 15) {
